...
use Yii;
use app\modules\admin\models\Departamento;
use app\modules\admin\models\DepartamentoSearch;
...
class DepartamentoController extends Controller
{
    ...
    public function actionDelete($id)
    {
        ...
        $usuario=SeguridadUsuarios::find()->where(['id_direccion'=>$id])->one();
        if($usuario)
        {
            Yii::$app->session->setFlash('warning','No se puede eliminar el departamento esta asociado a un usuario');
        }
        else
        {
             Yii::$app->session->setFlash('success','Departamento eliminado exitosamente');
             $borrar->delete();
        }
